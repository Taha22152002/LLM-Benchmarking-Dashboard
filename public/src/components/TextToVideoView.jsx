...
export default function TextToVideoView({ loading, error, sortConfig, handleSort, sortedData }) {
  if (loading)
    return (
  ...
  if (!sortedData?.length)
    return (
      <p className="text-center text-gray-500 py-10 text-lg">
        No Text-to-Video data available.
      </p>
    );
  ...
  return (
    <>
      <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-2 border-indigo-100">
        🎥 Text-to-Video Models — ELO Rankings
      </h2>
